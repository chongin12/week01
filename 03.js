...
- 설명
지역에서 var 변수를 선언해도 다른 곳에서 참조할 수 있다.
*/
...
- 설명
함수 안에서 정의한 var 변수는 전역 var 변수와 값을 공유하지 않는다.
*/
...
- 설명
null이라는 값이 들어간 순간부터 object로 본다. 가 아니라
null은 null이다. 자바스크립트의 오류
